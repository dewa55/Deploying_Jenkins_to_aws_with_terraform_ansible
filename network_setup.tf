...
#Creates Security Group to allow TCP/8080 from * and TCP/22 from home IP in us-east-1
...
#Creates Security Group  for Load Balancer, only TCP/80,TCP/443 and outgoing access is allowed to VM
...
#Creates Security Group to allow TCP/22 from home IP in us-west-2
